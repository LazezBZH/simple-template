// d'après https://github.com/raficraft/horizontal-webSite-engine

function initScroll() {
  console.log("scroll", screen.width);
...
if (screen.width > 1023) initScroll();
console.log("scroll2", screen.width);
